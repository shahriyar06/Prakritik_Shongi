            ...
            >
                    ...
                    <div className=' bg-cover bg-center min-h-screen' style={{ backgroundImage: "url('https://i.ibb.co/WPHyFrZ/slider0.jpg')" }}>
                        <div className='bg-black min-h-screen bg-opacity-60'>
                            <div className='lg:pt-44 pt-36'>
                                <h2 className='text-[#FFFFFF] text-center w-5/6 lg:w-4/6 mx-auto text-3xl lg:text-6xl font-bold'>Take your creativity anywhere with the <span className='text-[#A1662F]'>Prakritik Shongi..</span></h2>
                ...
                <SwiperSlide>
                    <div className=' bg-cover bg-center min-h-screen' style={{ backgroundImage: "url('https://i.ibb.co/rsf6zVL/slider1.jpg')" }}>
                        <div className='bg-black min-h-screen bg-opacity-60'>
                            <div className='pt-48'>
                                <h2 className='text-[#FFFFFF] text-center w-5/6 lg:w-4/6 mx-auto text-3xl lg:text-6xl font-bold'>Do not just dream it. <span className='text-[#8b4513]'>Make it..</span></h2>
                ...
                <SwiperSlide>
                    <div className=' bg-cover bg-center min-h-screen' style={{ backgroundImage: "url('https://i.ibb.co/H2x1D8S/slider3.jpg')" }}>
                        <div className='bg-black min-h-screen bg-opacity-60'>
                            <div className='pt-44'>
                                <h2 className='text-[#FFFFFF] text-center w-5/6 lg:w-4/6 mx-auto text-3xl lg:text-6xl font-bold'>Turning Dreams into <span className='text-[#a0522d]'>Artisanal</span> Reality.</h2>
