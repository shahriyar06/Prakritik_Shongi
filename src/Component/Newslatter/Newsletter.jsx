    ...
    return (
        <div className="mb-2 bg-cover bg-center h-[500px]" style={{ backgroundImage: "url('https://i.ibb.co/wwpdsVP/wooden-sculpture.jpg')" }}>
            <div className="p-40" >
                ...
                <div className='lg:w-6/12 w-4/5 mx-auto mt-7 relative'>
                    ...
                    <button className="btn rounded-r-full h-14 w-36 btn-outline text-[#947351] hover:text-[#FFFFFF] hover:bg-[#947351] hover:border-[#947351] text-xl absolute right-0">Signup</button>
                </div>
            </div>
        </div>
    );
